...
支持 **Claude Code · CodeBuddy · WorkBuddy · Codex 桌面版 · Cursor**。
...
**其他宿主**（Claude Code / CodeBuddy / WorkBuddy / Codex 桌面版）**没有这个限制**——它们的 `PreCompact` hook 接受 `additionalContext`，能真正让模型在压缩前写完摘要。
